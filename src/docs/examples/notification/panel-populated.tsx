...
import { NotificationPanel, type NotificationItemData } from "@/components/ui/notification"

export default function NotificationPanelPopulatedExample() {
    ...
    <div className="flex flex-col gap-2">
      ...
      {viewAllClicked && (
        <span className="text-xs text-[var(--s-color-text-subtlest)]">
          &quot;View all notifications&quot; fired onViewAll.
        </span>
      )}
    </div>
  )
